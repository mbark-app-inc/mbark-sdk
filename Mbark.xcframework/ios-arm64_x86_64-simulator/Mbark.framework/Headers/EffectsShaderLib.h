...
#ifndef EffectsShaderLib_h
#define EffectsShaderLib_h
...
typedef struct EffectsVertex EffectsVertex;

struct EffectsColorMatrix {
    matrix_float4x4 matrix;
    vector_float4 bias;
};
typedef struct EffectsColorMatrix EffectsColorMatrix;

struct EffectsCLAHELUTGeneratorInputParameters {
    uint histogramBins;
    uint clipLimit;
    uint totalPixelCountPerTile;
    uint numberOfLUTs;
};
typedef struct EffectsCLAHELUTGeneratorInputParameters EffectsCLAHELUTGeneratorInputParameters;

struct EffectsMultilayerCompositingLayerShadingParameters {
...
typedef struct EffectsMultilayerCompositingLayerShadingParameters EffectsMultilayerCompositingLayerShadingParameters;

struct EffectsMultilayerCompositingLayerVertex {
    vector_float4 position;
    vector_float2 textureCoordinate;
    vector_float2 positionInLayer;
};
typedef struct EffectsMultilayerCompositingLayerVertex EffectsMultilayerCompositingLayerVertex;
...
namespace mbark {
    ...
    typedef ::EffectsVertex VertexIn;
    ...
    } EffectsMultilayerCompositingLayerVertexOut;
