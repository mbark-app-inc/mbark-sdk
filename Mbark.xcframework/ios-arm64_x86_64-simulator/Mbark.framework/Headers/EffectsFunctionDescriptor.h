//
//  EffectsFilterFunctionDescriptor.h
//  Mbark
//
...
@interface EffectsFunctionDescriptor : NSObject <NSCopying>
...
- (EffectsFunctionDescriptor *)functionDescriptorWithConstantValues:(nullable MTLFunctionConstantValues *)constantValues;
