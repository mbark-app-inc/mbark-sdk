...
// WARNING: -[EffectsVector isEqual:] may not work on EffectsVector which contains a simd_type3 or simd_typeNx3 value.

@interface EffectsVector (SIMD)
